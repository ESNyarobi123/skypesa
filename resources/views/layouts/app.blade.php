...
<body>
    ...
    <a href="https://wa.me/{{ str_replace(['+', ' '], '', $whatsappNumber) }}?text={{ $whatsappMessage }}" 
       ...
       style="position: fixed; bottom: 80px; right: 20px; z-index: 1000; background: #25D366; color: white; width: 60px; height: 60px; border-radius: 50%; display: flex; align-items: center; justify-content: center; box-shadow: 0 4px 12px rgba(37, 211, 102, 0.4); transition: transform 0.3s ease;">

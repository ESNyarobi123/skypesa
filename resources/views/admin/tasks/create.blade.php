    ...
    <div class="card card-body">
        <form action="{{ route('admin.tasks.store') }}" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="url" name="url" id="urlInput" class="form-control" value="{{ old('url') }}" placeholder="https://...">
            ...
            <div class="form-group" style="margin-top: var(--space-4);">
                ...
                <select name="link_pool_id" id="linkPoolSelect" class="form-control" onchange="toggleUrlRequired()">
                    ...
                    @foreach($linkPools as $pool)
                        <option value="{{ $pool->id }}" {{ old('link_pool_id') == $pool->id ? 'selected' : '' }}
                ...
                <small style="color: var(--text-muted); font-size: 0.75rem;">
                    🔀 Ukichagua pool, user atapata <strong>random link</strong> kila anapofungua task hii
                </small>
            </div>

...
@section('title', 'Create Link Pool')
@section('page-title', 'Create Link Pool')
@section('page-subtitle', 'Add a new pool for link rotation')

@section('content')
<div class="animate-in" style="max-width: 800px;">
    <div class="chart-card">
        <form action="{{ route('admin.linkpools.store') }}" method="POST">
            @csrf
            ...
            <div class="form-group-modern">
                ...
                <textarea name="description" class="form-input-modern" rows="3" 
                          placeholder="Describe this pool...">{{ old('description') }}</textarea>
            </div>
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1.5rem;">
                ...
                <div class="form-group-modern">
                    ...
                    <input type="text" name="icon" value="{{ old('icon', 'zap') }}" 
                ...
                <div class="form-group-modern">
                    ...
                    <div style="display: flex; gap: 0.5rem;">
                        ...
                        <input type="text" value="{{ old('color', '#10B981') }}" 
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1.5rem;">
                ...
                <div class="form-group-modern">
                    ...
                    <input type="number" name="reward_amount" value="{{ old('reward_amount', 5) }}" 
                ...
                <div class="form-group-modern">
                    ...
                    <input type="number" name="duration_seconds" value="{{ old('duration_seconds', 30) }}" 
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1.5rem;">
                ...
                <div class="form-group-modern">
                    ...
                    <input type="number" name="daily_user_limit" value="{{ old('daily_user_limit', 5) }}" 
                ...
                <div class="form-group-modern">
                    ...
                    <input type="number" name="cooldown_seconds" value="{{ old('cooldown_seconds', 120) }}" 

        ...
        <div class="chart-card" style="margin-bottom: 1.5rem;">
            <div class="chart-header">
                <div>
                    ...
                    <div class="chart-subtitle">Update text or video announcement</div>
                </div>
            </div>
            ...
            <div style="display: grid; gap: 1.25rem;">
                ...
                <div class="form-group-modern">
                    ...
                    <div style="display: flex; gap: 1rem;">
                        <label style="display: flex; align-items: center; gap: 0.5rem; padding: 1rem; background: var(--bg-elevated); border-radius: var(--radius-lg); cursor: pointer; border: 2px solid transparent; transition: all 0.2s;" class="media-type-option" data-type="text">
                            <input type="radio" name="media_type" value="text" {{ old('media_type', $announcement->media_type ?? 'text') === 'text' ? 'checked' : '' }} style="display: none;">
                        ...
                        <label style="display: flex; align-items: center; gap: 0.5rem; padding: 1rem; background: var(--bg-elevated); border-radius: var(--radius-lg); cursor: pointer; border: 2px solid transparent; transition: all 0.2s;" class="media-type-option" data-type="video">
                            <input type="radio" name="media_type" value="video" {{ old('media_type', $announcement->media_type) === 'video' ? 'checked' : '' }} style="display: none;">
                            <span style="font-size: 1.5rem;">🎬</span>
                            <div>
                ...
                <div class="form-group-modern" id="textContentSection">
                    ...
                    <textarea name="body" class="form-input-modern" rows="5" 
                              placeholder="Write your announcement message here..." id="bodyInput">{{ old('body', $announcement->body) }}</textarea>
                    @error('body')
                    <p style="color: var(--error); font-size: 0.75rem; margin-top: 0.25rem;">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="form-group-modern" id="videoUploadSection" style="display: none;">
                    ...
                    <div id="currentVideoSection" style="margin-bottom: 1rem; padding: 1rem; background: var(--bg-elevated); border-radius: var(--radius-lg);">
                        <p style="font-size: 0.85rem; color: var(--text-muted); margin-bottom: 0.5rem;">Current Video:</p>
                        <video src="{{ $announcement->video_url }}" style="max-width: 100%; max-height: 150px; border-radius: var(--radius-md);" controls></video>
                        <p style="font-size: 0.75rem; color: var(--primary); margin-top: 0.5rem;">
                            ✅ Duration: {{ $announcement->video_duration ?? '?' }} seconds
                        </p>
                        <p style="font-size: 0.7rem; color: var(--text-muted); margin-top: 0.25rem;">Upload new video below to replace</p>
                    </div>
                    @endif
                    ...
                    <div id="videoDropZone" style="border: 2px dashed rgba(255,255,255,0.2); border-radius: var(--radius-lg); padding: 2rem; text-align: center; cursor: pointer; transition: all 0.3s;">
                        ...
                        <input type="hidden" name="video_duration" id="videoDuration" value="{{ $announcement->video_duration ?? 15 }}">
                    </div>

    ...
    public function run(): void
    {
        ...
        $plans = [
            [
                ...
                'daily_task_limit' => 20,
                'reward_per_task' => 3, // TZS 3 per task
            ...
            [
                ...
                'duration_days' => 30,
                'daily_task_limit' => 40,
                'reward_per_task' => 5, // TZS 5 per task (increased from 4)
                'min_withdrawal' => 3000,
            ...
            [
                ...
                'duration_days' => 30,
                'daily_task_limit' => 80, // Increased from 60
                'reward_per_task' => 8, // TZS 8 per task (increased from 5)
                'min_withdrawal' => 2000,
                'withdrawal_fee_percent' => 12, // Changed from 10%
                'processing_days' => 3,
                'badge_color' => '#94a3b8',
                'icon' => 'shield',
                'sort_order' => 3,
            ...
            [
                ...
                'duration_days' => 30,
                'daily_task_limit' => 120, // Increased from 100
                'reward_per_task' => 10, // TZS 10 per task (increased from 7)
                'min_withdrawal' => 1500,
                'withdrawal_fee_percent' => 8, // Changed from 7%
                'processing_days' => 2,
                'badge_color' => '#f59e0b',
                'icon' => 'award',
                'sort_order' => 4,
            ...
            [
                'name' => 'vip',
                'display_name' => 'VIP',
                'description' => 'Kiwango cha juu kabisa! Unlimited tasks, malipo bora, na withdrawal ya haraka sana.',
                'price' => 15000, // TZS 15,000 subscription (reduced from 25,000)
                'duration_days' => 30,
                'daily_task_limit' => null, // Unlimited
                'reward_per_task' => 12, // TZS 12 per task (increased from 10)
                'min_withdrawal' => 500, // Reduced from 1000
                'withdrawal_fee_percent' => 5,
                'processing_days' => 1, // Same day (24 hours)
                'badge_color' => '#10b981',
                'icon' => 'crown',
                'sort_order' => 5,
                'is_active' => true,
